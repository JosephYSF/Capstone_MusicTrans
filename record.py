...
def get_audio(filepath):
    ...
    with open('/Users/sf/Desktop/RU/Capstone/SourceCode/Web/resource/set.txt', 'w+') as f:
        f.seek(0)
        f.truncate()
    print("*" * 10, "Start recording")
    frames = []
    while True:
        with open('/Users/sf/Desktop/RU/Capstone/SourceCode/Web/resource/set.txt', 'r') as f:
            lines = f.readlines()
            if len(lines) > 0:
                line = lines[0]
                if line == 'q':
