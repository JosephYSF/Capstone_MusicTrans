# A format for transforming the note into number
...
def num(yin):
    ...
    if yin == "F3" or yin == "f3" or yin == ".fa" or yin == ".4" or yin == ".Fa" or yin == ".FA":  # fa
        return 53
    if yin == "G3" or yin == "g3" or yin == ".so" or yin == ".sol" or yin == ".5" or yin == ".So" or yin == ".Sol" or \
            yin == ".SO" or yin == ".SOL":  # so 或者说 sol
        return 55
    ...
    if yin == "B3" or yin == "b3" or yin == ".si" or yin == ".7" or yin == ".Si" or yin == ".SI":  # si
        return 59
    # 中音区
    if yin == "C4" or yin == "c4" or yin == "C" or yin == "c" or yin == "1" or yin == 1 or yin == "do" or yin == "Do" \
            or yin == "DO":  # 中音do
        return 60
    if yin == "D4" or yin == "d4" or yin == "D" or yin == "d" or yin == "2" or yin == 2 or yin == "re" or yin == "Re" \
            or yin == "RE":  # 中音re
        return 62
    if yin == "E4" or yin == "e4" or yin == "E" or yin == "e" or yin == "3" or yin == 3 or yin == "mi" or yin == "Mi" \
            or yin == "MI":  # 中音mi
        return 64
    if yin == "F4" or yin == "f4" or yin == "F" or yin == "f" or yin == "4" or yin == 4 or yin == "fa" or yin == "Fa" \
            or yin == "FA":  # 中音fa
        return 65
    if yin == "G4" or yin == "g4" or yin == "G" or yin == "g" or yin == "5" or yin == 5 or yin == "so" or yin == "sol" \
            or yin == "So" or yin == "Sol" or yin == "SO" or yin == "SOL":  # 中音so  或者说 sol
        return 67
    if yin == "A4" or yin == "a4" or yin == "A" or yin == "a" or yin == "6" or yin == 6 or yin == "la" or yin == "La" \
            or yin == "LA":  # 中音la
        return 69
    if yin == "B4" or yin == "b4" or yin == "B" or yin == "b" or yin == "7" or yin == 7 or yin == "si" or yin == "Si" \
            or yin == "SI":  # 中音si
        return 71
    # 高音区
    ...
    if yin == "F5" or yin == "f5" or yin == "4." or yin == "fa." or yin == "Fa." or yin == "FA.":  # fa
        return 77
    if yin == "G5" or yin == "g5" or yin == "5." or yin == "so." or yin == "So." or yin == "SO." or yin == "sol." or \
            yin == "Sol." or yin == "SOL.":  # so 或者说是 sol
        return 79
