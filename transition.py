...
mid = MidiFile()
track = MidiTrack()
file_path = '/Users/sf/Desktop/RU/Capstone/SourceCode/Web/resource/xiaoxingxing.wav'
...
def transition(file_path):
    ...
    plt.tight_layout()
    plt.savefig('/Users/sf/Desktop/RU/Capstone/SourceCode/Web/static/img/spec.png')
    plt.show()

    plt.figure(figsize=(15, 5))
    librosa.display.specshow(chromagram, x_axis='time', y_axis='chroma', hop_length=hop_length, cmap='coolwarm')
    plt.savefig('/Users/sf/Desktop/RU/Capstone/SourceCode/Web/static/img/chroma.png')
    plt.show()
    ...
    buildSheet = []
    c = 0
    dic = {"c4": 265.0, "c4#":280.0, "d4": 291.0, "d4#": 317.0, "e4": 336.5, "f4": 356.0,"f4#": 375.5, "g4": 401.5, "a4": 453.5, "b4": 512.0, "c5":544.0, "d5": 616.0,"e5":690.0,"f5":740.0,"g5":830.0,"a5":940.0,"b5":1050.0,"c6":1116.5,"d6":1246.5,"e6":1370.0,"f6":1428.5}
